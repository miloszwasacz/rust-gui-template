//! A module for rendering the example animation. Can be safely removed from an actual application.
...
pub fn render_frame(
    ...
    let step = 60.0 * bpm as f32 / 60.0 / fps as f32;
    ...
    match vertex {
        Some(index) => {
            ...
            let radii = match index {
                ...
                _ => panic!("Invalid vertex index {index} for triangle."),
            };
